---
name: flutter-rules-maintainer
description: 维护并执行 Flutter 跨平台应用约束规范。用于用户要求新增、修改、重构、审计或对齐 `flutter` 规则体系时触发，适用于 Dart 编码规范、跨平台架构、设备适配、状态管理等规则维护场景；当需求涉及 API 契约、联调、发布顺序时需联动 `rules/frontend-backend-collaboration.md`。
