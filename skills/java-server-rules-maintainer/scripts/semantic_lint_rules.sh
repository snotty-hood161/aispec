...
COMMON_DIR="$RULES_ROOT/java-server/common"
PROFILE_MONOLITH="$RULES_ROOT/java-server/profiles/monolith/project-structure.md"
PROFILE_MICRO="$RULES_ROOT/java-server/profiles/microservice/project-structure.md"
