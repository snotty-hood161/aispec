...
COMMON_DIR="$RULES_ROOT/node-server/common"
PROFILE_MONOLITH="$RULES_ROOT/node-server/profiles/monolith/project-structure.md"
PROFILE_MICRO="$RULES_ROOT/node-server/profiles/microservice/project-structure.md"
...
check "$cfg_file" '数据库类型' "数据库类型字段约束"
...
check "$forbid_file" "禁止使用 console.log" "禁止 console.log 日志"
