...
| 测试与发布门禁 | `common/testing-and-release.md` | `rules/templates/node-server/pr-review-checklist.md` |
| 禁止项（反模式） | `common/forbidden.md` | 各主题文件（反向校验） |
| PR 评审清单 | `rules/templates/node-server/pr-review-checklist.md` | `common/testing-and-release.md` |
